...
mixin _$LoginModel {
 ...
 String? get status; String? get token; UserModel? get user;
...
@useResult
$Res call({
 String? status, String? token, UserModel? user
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? status,  String? token,  UserModel? user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? status,  String? token,  UserModel? user)  $default,) {final _that = this;
switch (_that) {
case _LoginModel():
return $default(_that.status,_that.token,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? status,  String? token,  UserModel? user)?  $default,) {final _that = this;
switch (_that) {
case _LoginModel() when $default != null:
return $default(_that.status,_that.token,_that.user);case _:
  return null;
